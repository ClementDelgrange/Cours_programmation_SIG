% Description: TD de programmation sous SIG - Le système ArcGIS
...
%	\item \url{http://server.arcgis.com/fr/server/}
%\end{itemize}
...
Les données initiales se trouvent sur \href{run:/ensg1.ensg.eu/partages/formationTemp/ING2/ProgSIG}{formationTemp}

\action Copiez-les sur votre poste dans \textit{D:\textbackslash{}ProgSIG\textbackslash{}TD1\textbackslash{}Data}.



\section{Préparation des données}

\action Dans ArcMap, créez un nouveau document \textit{TD1.mxd} que vous enregistrerez dans \textit{D:\textbackslash{}ProgSIG\textbackslash{}TD1}.
...
\begin{figure}[H]
	\center \includegraphics{img/td1/am_ajouter_connexion_dossier.png}
\end{figure}
...
\begin{figure}[H]
	\center \includegraphics{img/td1/am_ajouter_connexion_dossier_ok.png}
\end{figure}

%\begin{note}
%Afin de gagner en souplesse en cas de déplacement de votre répertoire de travail, vous pouvez aller dans le menu \textbf{Fichier}, ouvrir la fenêtre \textbf{Propriétés de la carte} puis cocher la case \textbf{Enregistrer les chemins relatifs aux sources de données}.
%\begin{figure}[H]
%	\center \includegraphics[width=0.4\textwidth]{img/td1/am_proprietes_carte.png}
%\end{figure}
%\vspace{2em}
%\end{note}
...
\begin{figure}[H]
	\center \includegraphics{img/td1/am_ajouter_donnees.png}
\end{figure}
...
\begin{figure}[H]
	\center \includegraphics{img/td1/am_ajouter_fond_carte.jpg} \\
\end{figure}
\end{note}
...
Pour le premier contrôle, nous nous aiderons d'une extension \textit{SelectStackedFeatureAddIn}, disponible dans les données sources que vous avez copiées sur votre poste. 
...
\begin{figure}[H]
	\center \includegraphics[width=0.5\textwidth]{img/td1/am_gestionnaire_complements_options.png} \\
\end{figure}
...
\begin{figure}[H]
	\center \includegraphics[width=0.5\textwidth]{img/td1/am_fenetre_personnaliser.png} \\
\end{figure}
...
%\begin{figure}[H]
%	\center \includegraphics[width=0.5\textwidth]{img/td1/ago_ajouter_service_web.png} \\
%\end{figure}
%
...
%\begin{figure}[H]
%	\center \includegraphics{img/td1/am_ajout_wms-1.png} \\
%\end{figure}
%
%\action Indiquez l'URL de votre flux WMS, vérifiez les couches disponibles et validez.
%\begin{figure}[H]
%	\center \includegraphics[width=0.5\textwidth]{img/td1/am_ajout_wms-2.jpg} \\
%\end{figure}
%
...
%\begin{figure}[H]
%	\center \includegraphics{img/td1/am_ajouter_serveur_arcgis.jpg} \\
%\end{figure}
%
%\action Nous souhaitons pour l'instant publier de nouvelles ressources sur le serveur (\textit{publier les services GIS})
%\begin{figure}[H]
%	\center \includegraphics[width=0.5\textwidth]{img/td1/am_ajouter_serveur_arcgis-2.png} \\
%\end{figure}
%
...
%
%\begin{figure}[H]
%	\center \includegraphics[width=0.5\textwidth]{img/td1/am_connexion_serveur_arcgis.png} \\
%\end{figure}
%
%Lorsque vous validez, le serveur zebra.ensg.eu apparaît dans la liste des serveurs.
%\begin{figure}[H]
%	\center \includegraphics{img/td1/am_connexion_ok_serveur_arcgis.png} \\
%\end{figure}
%
...
%\begin{figure}[H]
%	\center \includegraphics[width=0.4\textwidth]{img/td1/am_publier_sd-1.jpg} \\
%\end{figure}
%
...
%\begin{figure}[H]
%	\center \includegraphics[width=0.4\textwidth]{img/td1/am_publier_sd-2.png} \\
%\end{figure}
%
...
%\begin{figure}[H]
%	\center \includegraphics[width=0.4\textwidth]{img/td1/am_publier_sd-3.png} \\
%\end{figure}
%
...
%\begin{figure}[H]
%	\center \includegraphics[width=0.4\textwidth]{img/td1/am_publier_sd-4.png} \\
%\end{figure}
%
...
%
%\begin{figure}[H]
%	\center \includegraphics[width=0.7\textwidth]{img/td1/am_publier_sd_parametrage.png} \\
%\end{figure}
%
...
%\begin{figure}[H]
%	\center \includegraphics{img/td1/am_publier_sd-5.png} \\
%\end{figure}
%
...
%\begin{figure}[H]
%%	\center \includegraphics{img/td1/am_service_ags.png} \\
%\end{figure}
%
...
%\begin{figure}[H]
%%	\center \includegraphics[width=0.7\textwidth]{img/td1/am_service_url_rest.png} \\
%\end{figure}
%
...
%\subsection{Découverte d'AppStudio for ArcGIS}
%Nous nous proposons dans cette partie de réaliser une application SIG pour support mobiles (smartphone, tablette). On utilisera pour cela AppStudio for ArcGIS.
%
%Rendez-vous sur la page \url{http://appstudio.arcgis.com} > \textit{Create your app}. 
%Plusieurs modèles d'applications sont possibles. 
%$\Rightarrow$ Utilisez le modèle \textit{Quick Report}.
%
%A l'étape suivante, vous pouvez choisir une icône pour votre application, lui mettre une image de fond, etc. 
%
%$\Rightarrow$ Dans \textit{Quick Report Setting}, choisissez comme ressource à utiliser la \textit{Feature Layer TD1-toponyme} d'ArcGIS Online.
%\begin{figure}[H]
%	\center \includegraphics[width=0.30\textwidth]{img/td1/app_studio.jpg} \\
%\end{figure}
%
%L'application est fonctionnelle même si on pourrait encore l'améliorer en lui ajoutant des widgets. 
%
%$\Rightarrow$ Générez les exécutables en cliquant sur \textbf{Build App}. Sélectionnez ensuite les supports pour lesquels vous souhaitez générer votre application.
%
%$\Rightarrow$ Installez l'application sur le support choisi pour la tester.
%
%
%\subsection{Viewer Flex for ArcGIS}
%A partir du Viewer Flex for ArcGIS et de la carte web TD1-vegetation publiée précédement, créez une application web SIG. Observer le code source de la page. Avec quelle API votre application consomme-t-elle les géoservices d’ArcGIS Online ?
%
%
%
%\underline{Remarque générale} : toute la partie administration d'un ArcGIS for Serveur ou d'ArcGIS Online peut être automatisée à l'aide de scripts en faisant notamment appel à l'API REST d'ArcGIS. On entend ici par administration : la gestion des services (publication, suppression, mise à jour), le chargement des données associées à ces servies, la gestion des utilisateurs et des droits d'accès. Un projet comme ArcREST, géré sur la plateforme GitHub (\url{https://github.com/Esri/ArcREST}), propose enfin une surcouche en Python à l'API REST afin de rendre ses fonctionnalités plus facile d'accès.
